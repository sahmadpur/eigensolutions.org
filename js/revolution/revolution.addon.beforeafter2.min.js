...
if ($("body").hasClass("before-after")) {
    ...
    tpj(document).ready(function() {
        if(tpj("#rev_slider_346_2").revolution == undefined){
            revslider_showDoubleJqueryError("#rev_slider_346_2");
        }else{
            revapi346 = tpj("#rev_slider_346_2").show().revolution({
                sliderType: "standard",
            ...
            RevSliderBeforeAfter(tpj, tpj("#rev_slider_346_2"), {
                arrowStyles: {
                    leftIcon: "fa fa-caret",
                    rightIcon: "fa fa-caret",
